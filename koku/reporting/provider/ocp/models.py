...
class OCPInferenceTokenSummaryP(models.Model):
    ...
    sla_compliance = models.DecimalField(max_digits=5, decimal_places=4, null=True)
    sla_good = models.DecimalField(max_digits=5, decimal_places=4, null=True)
    sla_degraded = models.DecimalField(max_digits=5, decimal_places=4, null=True)
    sla_breached = models.DecimalField(max_digits=5, decimal_places=4, null=True)
